...
def main(instance="example"):
    ...
    ga = GaFjspNew(pop_size=60, rc=0.65, rm=0.35, max_generation=int(10e4), objective=Objective.makespan,
    ...
    GaTemplate(save="GA_FjspNew_dpox", instance=instance, ga=ga, n_exp=10)
