...
def main(instance="example"):
    ...
    ga2 = GaFspHfspWorkTimetable(pop_size=ga.pop_size, rc=ga.rc, rm=ga.rm, max_generation=MAX_GENERATION2,
                                 objective=Objective.makespan, schedule=problem2,
                                 max_stay_generation=MAX_STAY_GENERATION2)
    ...
    GaTemplate(save="GA_FSPWT", instance=instance, ga=ga, ga2=ga2, n_exp=N_EXP)


def exp():
    # for instance in CASES_LIST.split():
    for instance in fsp_simulation.case.keys():
